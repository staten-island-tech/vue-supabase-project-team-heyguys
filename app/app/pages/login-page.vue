<template>
    <div
        ...
        <div class="flex flex-col justify-around items-center bg-slate-300/60 z-10 w-[80%] h-[70%] mt-[5%] rounded-[5rem] border-yellow-500 border-2">
            ...
            <div class="h-[30%] lg:w-[90%] w-full flex flex-col lg:flex-row justify-between items-center">
            ...
            @click="useLoginStore().login">     Log In </button>

                <div class="lg:w-[10%] w-[20%] h-[20%] my-[5%] bg-white/70 lg:h-[60%] flex items-center justify-center rounded-3xl">
                    <h4 class="text-center text-yellow-500 press-start text-md lg:text-lg"> OR </h4>
                </div>

                <button class="bg-white border-yellow-500 border-4 text-xl lg:text-3xl rounded-3xl press-start text-yellow-500 h-[80%] w-[42%]
                transition-all ease-in-out hover:bg-yellow-200 hover:-translate-y-[2%] active:translate-y-[2%] active:bg-yellow-300"
                @click="useLoginStore().register">     Register </button>
            </div>
        </div>
    </div>
</template>
